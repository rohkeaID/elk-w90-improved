...
! compute the potential and G=0 coefficient of the density
      ...
      call zpotcoul(nrcmt,nrcmti,npcmt,npcmti,nrcmtmax,rcmt,ng2gk,igq0,gqc, &
       ng2gk,jlgqrmt,ylmgq,sfacgq,zrhoir(:,ist1),npcmtmax,zvclmt,zvclir,zgq02)
      z1=zfinp(zrhomt(:,:,ist1),zrhoir(:,ist1),zvclmt,zvclir)
      t1=cfq*wiq2(iq)*(dble(zgq02)**2+aimag(zgq02)**2)
...
! compute the density coefficient of the smallest G+q-vector
        call zftgq0(jlgq0r,ylmgq(:,igq0),sfacgq0,zrhomt(:,:,ist3), &
         zrhoir(:,ist3),zgq01)
